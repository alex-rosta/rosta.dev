  ...
  return (
    (<div
      ...
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        ...
        <p
          className="text-neutral-700 dark:text-neutral-300 text-sm font-bold md:text-base max-w-sm">
          I&apos;ve been working in the IT industry for over 5 years now. Here&apos;s a quick summary of my professional journey.
        </p>
      </div>

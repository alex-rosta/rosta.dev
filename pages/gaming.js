...
export const GamingPage = () => {
    ...
    const maxPlaytime = games.length > 0 ? Math.max(...games.map(game => game.playtimeHours)) : 1;
                        ...
                        <Col md={12}>
                            {userInfo ? (
                                <div className="user-info">
                                    ...
                                    <p> <strong>Last Online:</strong> {userInfo.lastonline} </p>
                                    <p> <a href={userInfo.profileurl} target="_blank" rel="noopener noreferrer">{userInfo.profileurl}</a></p>
                                    <p> <img src={userInfo.avatar} alt="User Avatar" /></p>
                                </div>
                            ) : (

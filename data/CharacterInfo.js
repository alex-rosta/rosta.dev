    ...
    return (
        <div className='shadow-md rounded-lg p-6 mt-46'>
            ...
            <div className="bg-gradient-to-br from-yellow-500 to-yellow-700 p-4 rounded-lg shadow-inner">
                ...
                <strong>{character.name} {character.title}</strong> <br />
                <strong>{character.realm}</strong> <br />
                <strong style={{ color: classColor }}>{character.specialization} {character.class}</strong> <br />
                <strong>Level: {character.level}</strong><br />
                <strong>
                    Last Login:</strong> <strong style={{ color: isRecentLogin ? 'green' : 'inherit' }}>
                    {character.lastLogin}</strong> <br />
                <strong>Achievement Points:</strong> {character.achievementPoints} <br />
                <strong>Faction:</strong> <strong style={{ color: factionColor }}>{character.faction}</strong> <br />
                <strong>Item Level:</strong> {character.equippedItemLevel} <br />
                <strong>Guild: {character.guild}</strong><br />
            </div>
        </div>
    );
};
